...
# Build container
docker build -t ${account_id}.dkr.ecr.${region}.amazonaws.com/${registry_url}:latest .
docker build -t ${account_id}.dkr.ecr.${region}.amazonaws.com/${registry_url}:${image_tag} .

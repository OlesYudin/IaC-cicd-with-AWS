...
locals {
  # List variables for application store in: $TERRAGRUNT_ROOT_DIR/$ENV/variables/app_var.hcl
  app_var = read_terragrunt_config(find_in_parent_folders("variables/app_var.hcl"))
  # List variables for network (VPC) store in: $TERRAGRUNT_ROOT_DIR/$ENV/variables/network_var.hcl
